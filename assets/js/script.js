...
const sloganCompany = {
    template: `<section class="slogan container">
                    ...
                    <img src="./assets/img/site/slogan_img.png" alt="img" class="slogan__img" />
                </section>`,
}
...
const myPopup = {
    template: `<section class="popup" v-if="workItem">
                    <div :style="computedStyles">
                        ...
                        <img src="./assets/img/site/likemen.png" alt="likeman" class="popup__likeman">
                        <img 
                            src="./assets/img/site/close.svg" 
                            alt="close" 
                            class="popup__close"
    ...
    template: `<footer>
                    <div class="footer_content container">
                        <div class="footer_content__info-company">
                            ...
                            <p class="footer_content__info-company__copyright">
                                © Work Space, 2023
                            </p>
                        </div>
